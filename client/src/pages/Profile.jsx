...
function Profile() {
  ...
  const [userListings, setUserListings] = useState([]); //state to store the user listings
  ...
  const handleFileUpload = (file) => {
    ...
    const fileName = new Date().getTime() + file.name; //added time to always get a unique file name.
